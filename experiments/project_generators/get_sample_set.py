...
for seed in [10, 4156, 2536, 2123, 7058, 1087, 8306]:
    for cmd in [
        ...
        data["script"][7] = "python3 $BUILD_CACHE_PATH/trident/experiments/simulation/get_sample_set.py %s" % cmd
        res.append(data)
        i+=1


    with open("projects/get_sample_set.json", "w") as f:
