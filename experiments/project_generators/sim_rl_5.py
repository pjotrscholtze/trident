    ...
    for cache_size in [2*1000*1000, 2000*1000*1000, 2000*1000*1000*1000]:
        for history_size in [1, 6]:
            ...
            for _ in range(0, 24):
                ...
                cmd = "%d %d /var/scratch/pse740/cache/query_sets/25000_%s.json %d %s" % (history_size, cache_size, seed, mask, ("/var/scratch/pse740/rl_results/sim-rl-5_%d.json" % i))
...
with open("projects/sim-rl-5.json", "w") as f:
