...
base_raw = """
{
    "name": "generate-dbpedia-db-times-details",
    ...
    "script": [
        ...
        "time $BUILD_CACHE_PATH/trident/trident load -i $DATABASE_PATH/dbpedia-times-details -f /var/scratch/pse740/db/dbpedia_raw/file.nt.gz -l debug   --timingLocation $PROJECT_PATH/times 2>&1",
...
with open("projects/generate-dbpedia-db-times-details.json", "w") as f:
