...
for seed in [10, 4156, 2536, 2123, 7058, 1087, 8306]:
    ...
    for cmd in [
        "python main.py 25000 0.1 SEED 2 equi_width full $PROJECT_PATH/sim_stats.json",
        "python main.py 25000 0.2 SEED 2 equi_width full $PROJECT_PATH/sim_stats.json",
        "python main.py 25000 0.3 SEED 2 equi_width full $PROJECT_PATH/sim_stats.json",

        "python main.py 25000 0.1 SEED 2 v_optimal full $PROJECT_PATH/sim_stats.json",
        "python main.py 25000 0.2 SEED 2 v_optimal full $PROJECT_PATH/sim_stats.json",
        "python main.py 25000 0.3 SEED 2 v_optimal full $PROJECT_PATH/sim_stats.json",

        "python main.py 25000 0.1 SEED 2 maxdiff full $PROJECT_PATH/sim_stats.json",
        "python main.py 25000 0.2 SEED 2 maxdiff full $PROJECT_PATH/sim_stats.json",
        "python main.py 25000 0.3 SEED 2 maxdiff full $PROJECT_PATH/sim_stats.json",
        ]:
...
with open("projects/sim-hist-2.json", "w") as f:
