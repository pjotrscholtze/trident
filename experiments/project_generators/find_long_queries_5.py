...
base_raw = """
{
    "name": "find_long_queries_5-%d",
    "description": "find_long_queries first itteration of this, using a single repitition, database generated with a single index. These jobs run longer then normal, watch this with the scheduler. Round 5.",
