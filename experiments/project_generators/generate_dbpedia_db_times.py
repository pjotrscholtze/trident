...
base_raw = """
{
    "name": "generate-dbpedia-db-times",
    "description": "Generate dbpedia, get times for tables",
    ...
    "script": [
        ...
        "time $BUILD_CACHE_PATH/trident/trident load -i $DATABASE_PATH/dbpedia-times -f /var/scratch/pse740/db/dbpedia_raw/file.nt.gz -l debug  2>&1",
        "du -h -d0 $DATABASE_PATH/dbpedia-times"
    ]
}
"""
...
with open("projects/generate-dbpedia-db-times.json", "w") as f:
