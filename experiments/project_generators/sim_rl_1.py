...
base_raw = """
{
    ...
    "script": [
        ...
        "module load cudnn/7.4.2 && module load tensorflow/python3.x/gpu/r1.1.0-py3 && module unload python/3.6.0 && du -h -d0 $DATABASE_PATH/dbpedia-times-details-nindices-1",
        "# __REPLACED_BELOW__",
        "# __REPLACED_BELOW__",
        "__REPLACED_BELOW__"
    ]
