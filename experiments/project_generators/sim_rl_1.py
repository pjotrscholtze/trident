...
base_raw = """
{
    ...
    "script": [
        ...
        "module load cuda10.0/toolkit && module load cuDNN/cuda10.0 && module unload python/3.6.0 && source /home/pse740/.bashrc && conda activate&& du -h -d0 $DATABASE_PATH/dbpedia-times-details-nindices-1",
        "# __REPLACED_BELOW__",
        "# __REPLACED_BELOW__",
        "__REPLACED_BELOW__"
    ]
