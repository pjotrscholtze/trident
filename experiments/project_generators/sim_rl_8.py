...
for seed in [10]:#, 4156, 2536, 2123, 7058, 1087, 8306]:
    ...
    for cache_size in [2*1000*1000, 2000*1000*1000, 2000*1000*1000*1000]:
        for history_size in [1, 6]:
            ...
            cmd = "%d %d /var/scratch/pse740/cache/query_sets/25000_%s.json %d %s" % (history_size, cache_size, seed, BASE_MASK ^ mask, ("/var/scratch/pse740/rl_results/sim-rl-8_%d.json" % i))
...
with open("projects/sim-rl-8.json", "w") as f:
