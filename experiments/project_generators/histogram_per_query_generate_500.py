...
base_raw = """
{
    "name": "histogram-generate-per-query-%d-500",
    "description": "Generate histogram/counters for index and table usage, repetition will be 5 times (generate the stats per query)",
...
with open("projects/histogram-generate-per-query-500.json", "w") as f:
