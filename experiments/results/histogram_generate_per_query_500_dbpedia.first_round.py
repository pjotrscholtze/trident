...
i = 0
# 
for p in glob("results/histogram-generate-per-query-500-dbpedia-cleaned-queries-first-round/*/temp.json"):
    i += 1
    with open(p, "r") as f:
...
with open("histogram-generate-per-query-500-dbpedia.combined.first-round.csv", "w") as f:
